# -*- coding: utf-8 -*-
"""
Created on Fri Sep 23 13:46:25 2022
...
def ecuacionPenduloSimple(y,t):
    ...
    return [omega, (-b/m)*omega + (-g/L)*np.sin(theta)]  # [dtheta/dt, domega/dt]
...
angulo_inicial = 130                 #angulo incial
...
plt.title("Pendulo Simple con Amortiguamiento")
plt.xlabel("Tiempo (s)")
